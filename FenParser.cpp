...
namespace ChessEngine {
    ...
    static void SetPieces(const PieceInfo& pieceInfo, const BoardTile& tile, Representation &representation){
    ...
    static bool ParsePiecePlacement(const std::string &placement, Representation &representation) {
    ...
    static bool ParseStartingTeam(const std::string &starting_team_string, Team &starting_team) {
    ...
    static bool ParseCastlingRights(const std::string &rights_string, CastlingRights &castling_rights) {
    ...
    static bool ParseMoveCounter(const std::string &counter_string, MoveCounters &move_counters, bool for_half) {
    ...
    static bool ParseEnPassant(const std::string &enPassant_string, Representation &representation) {
        if (enPassant_string == "-") {
            return true;
        }
